...
if ( ! class_exists( 'Illdy_Entry_Meta_Output' ) ) {
	...
	class Illdy_Entry_Meta_Output{
		...
		protected function __construct() {
			add_action( 'illdy_single_entry_meta', [ $this, 'single_entry_meta_output' ], 1 );
			add_action( 'illdy_archive_meta_content', [ $this, 'archive_entry_meta_output' ], 1 );
			add_action( 'illdy_single_after_content', [ $this, 'single_content_tags' ], 1 );
		}
