...
if ( get_theme_mod( $prefix . '_sponsors_general_entry' ) ) {
	...
	$wp_customize->add_setting( $prefix . '_sponsors_entry_text', [
		'sanitize_callback' => 'esc_html',
		'default'           => '',
		'transport'         => 'postMessage',
	] );
	$wp_customize->add_control( new Illdy_Text_Custom_Control( $wp_customize, $prefix . '_sponsors_entry_text', [
		...
		'section'     => $panel_id,
		'settings'    => $prefix . '_sponsors_entry_text',
		'priority'    => 3,
	] ) );
}
