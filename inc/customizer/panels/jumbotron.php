...
$wp_customize->add_setting( $prefix . '_jumbotron_enable_featured_image', [
	'sanitize_callback' => $prefix . '_sanitize_checkbox',
	'default'           => 0,
	'transport'         => 'postMessage',
] );

$wp_customize->add_control( new Epsilon_Control_Toggle( $wp_customize, $prefix . '_jumbotron_enable_featured_image', [
	'type'        => 'epsilon-toggle',
...
// Featured image in header
$wp_customize->add_setting( $prefix . '_jumbotron_enable_parallax_effect', [
	'sanitize_callback' => $prefix . '_sanitize_checkbox',
	'default'           => 1,
	'transport'         => 'postMessage',
] );

$wp_customize->add_control( new Epsilon_Control_Toggle( $wp_customize, $prefix . '_jumbotron_enable_parallax_effect', [
	'type'        => 'epsilon-toggle',
...
$wp_customize->add_setting( $prefix . '_jumbotron_title', [
	'sanitize_callback' => 'wp_kses_post',
	'default'           => __( 'Clean <span class="span-dot">.</span> Slick<span class="span-dot">.</span> Pixel Perfect', 'illdy' ),
	'transport'         => 'postMessage',
] );
$wp_customize->add_control( new Epsilon_Control_Text_Editor( $wp_customize, $prefix . '_jumbotron_title', [
	'label'   => __( 'Title', 'illdy' ),
	'section' => $prefix . '_jumbotron_general',
	'type'    => 'epsilon-text-editor',
] ) );
$wp_customize->selective_refresh->add_partial( $prefix . '_jumbotron_title', [
...
if ( get_theme_mod( $prefix . '_jumbotron_general_entry' ) ) {
	...
	$wp_customize->add_control( new Epsilon_Control_Text_Editor( $wp_customize, $prefix . '_jumbotron_general_entry', [
...
$wp_customize->selective_refresh->add_partial( $prefix . '_jumbotron_general_entry', [
...
$wp_customize->add_control( $prefix . '_jumbotron_general_first_button_title', [
	'label'   => __( 'First button title', 'illdy' ),
	'section' => $prefix . '_jumbotron_general',
] );
$wp_customize->selective_refresh->add_partial( $prefix . '_jumbotron_general_first_button_title', [
...
$wp_customize->add_control( $prefix . '_jumbotron_general_second_button_title', [
	'label'   => __( 'Second button title', 'illdy' ),
	'section' => $prefix . '_jumbotron_general',
] );
$wp_customize->selective_refresh->add_partial( $prefix . '_jumbotron_general_second_button_title', [
...
// Colors & Backgrounds
$wp_customize->add_setting( $prefix . '_jumbotron_tab', [
	'transport'         => 'postMessage',
	'sanitize_callback' => 'wp_kses_post',
] );
$wp_customize->add_control( new Epsilon_Control_Tab( $wp_customize, $prefix . '_jumbotron_tab', [
	'type'    => 'epsilon-tab',
	'section' => $prefix . '_jumbotron_general',
	'buttons' => [
		[
...
// Background Image
$wp_customize->add_setting( $prefix . '_jumbotron_background_type', [
	'default'           => 'image',
	'sanitize_callback' => 'sanitize_text_field',
] );
$wp_customize->add_control( $prefix . '_jumbotron_background_type', [
...
$wp_customize->add_setting( $prefix . '_jumbotron_general_image', [
	'sanitize_callback' => 'esc_url',
	'default'           => esc_url( get_template_directory_uri() . '/layout/images/front-page/front-page-header.jpg' ),
	'transport'         => 'refresh',
] );
$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, $prefix . '_jumbotron_general_image', [
	'label'           => __( 'Background Image', 'illdy' ),
	'section'         => $prefix . '_jumbotron_general',
	'settings'        => $prefix . '_jumbotron_general_image',
	'active_callback' => 'illdy_is_jumbotron_image',
] ) );
$wp_customize->add_setting( $prefix . '_jumbotron_background_position_x', [
	'default'           => 'center',
	'sanitize_callback' => 'esc_html',
	'transport'         => 'postMessage',
] );
$wp_customize->add_setting( $prefix . '_jumbotron_background_position_y', [
	'default'           => 'center',
	'sanitize_callback' => 'esc_html',
	'transport'         => 'postMessage',
] );
$wp_customize->add_control( new WP_Customize_Background_Position_Control( $wp_customize, $prefix . '_jumbotron_background_position', [
...
$wp_customize->add_setting( $prefix . '_jumbotron_background_size', [
	'default'           => 'cover',
	'sanitize_callback' => 'illdy_sanitize_background_size',
	'transport'         => 'postMessage',
] );
$wp_customize->add_control( $prefix . '_jumbotron_background_size', [
...
$wp_customize->add_setting( $prefix . '_jumbotron_background_repeat', [
	'sanitize_callback' => $prefix . '_sanitize_checkbox',
	'default'           => 0,
	'transport'         => 'postMessage',
] );

$wp_customize->add_control( new Epsilon_Control_Toggle( $wp_customize, $prefix . '_jumbotron_background_repeat', [
	'type'            => 'epsilon-toggle',
...
$wp_customize->add_setting( $prefix . '_jumbotron_background_attachment', [
	'sanitize_callback' => $prefix . '_sanitize_checkbox',
	'default'           => 0,
	'transport'         => 'postMessage',
] );

$wp_customize->add_control( new Epsilon_Control_Toggle( $wp_customize, $prefix . '_jumbotron_background_attachment', [
	'type'            => 'epsilon-toggle',
...
$wp_customize->add_setting( $prefix . '_jumbotron_video', [
	'transport'         => 'refresh',
	'sanitize_callback' => 'absint',
	'validate_callback' => [ $wp_customize, '_validate_header_video' ],
] );
$wp_customize->add_setting( $prefix . '_jumbotron_external_video', [
	'transport'         => 'refresh',
	'sanitize_callback' => [ $wp_customize, '_sanitize_external_header_video' ],
	'validate_callback' => [ $wp_customize, '_validate_external_header_video' ],
] );
$wp_customize->add_control( new WP_Customize_Media_Control( $wp_customize, $prefix . '_jumbotron_video', [
...
$wp_customize->add_control( $prefix . '_jumbotron_external_video', [
	'type'            => 'url',
...
// Controls for slider
Epsilon_Customizer::add_field( $prefix . '_jumbotron_slides', [
...
$wp_customize->add_setting( $prefix . '_jumbotron_slider_autoplay', [
	'sanitize_callback' => $prefix . '_sanitize_checkbox',
	'default'           => 1,
	'transport'         => 'refresh',
] );
$wp_customize->add_control( new Epsilon_Control_Toggle( $wp_customize, $prefix . '_jumbotron_slider_autoplay', [
	'type'            => 'epsilon-toggle',
...
$wp_customize->add_setting( $prefix . '_jumbotron_slider_autoplay_time', [
	'sanitize_callback' => 'absint',
	'default'           => 5000,
	'transport'         => 'refresh',
] );
$wp_customize->add_control( $prefix . '_jumbotron_slider_autoplay_time', [
...
$wp_customize->add_setting( $prefix . '_jumbotron_slider_nav', [
	'sanitize_callback' => $prefix . '_sanitize_checkbox',
	'default'           => 1,
	'transport'         => 'refresh',
] );
$wp_customize->add_control( new Epsilon_Control_Toggle( $wp_customize, $prefix . '_jumbotron_slider_nav', [
	'type'            => 'epsilon-toggle',
...
// Background Color
$wp_customize->add_setting( $prefix . '_jumbotron_general_color', [
	'sanitize_callback' => 'sanitize_hex_color',
	'default'           => '#000000',
	'transport'         => 'postMessage',

] );
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, $prefix . '_jumbotron_general_color', [
...
$wp_customize->add_setting( $prefix . '_jumbotron_first_button_background', [
	'sanitize_callback' => 'sanitize_hex_color',
	'default'           => '#fff',
	'transport'         => 'postMessage',
] );
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, $prefix . '_jumbotron_first_button_background', [
...
$wp_customize->add_setting( $prefix . '_jumbotron_second_button_background', [
	'sanitize_callback' => 'sanitize_hex_color',
	'default'           => '#f1d204',
	'transport'         => 'postMessage',
] );
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, $prefix . '_jumbotron_second_button_background', [
...
$wp_customize->add_setting( $prefix . '_jumbotron_second_button_background_hover', [
	'sanitize_callback' => 'sanitize_hex_color',
	'default'           => '#6a4d8a',
	'transport'         => 'postMessage',
] );
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, $prefix . '_jumbotron_second_button_background_hover', [
...
// Colors
$wp_customize->add_setting( $prefix . '_jumbotron_title_color', [
	'sanitize_callback' => 'sanitize_hex_color',
	'default'           => '#fff',
	'transport'         => 'postMessage',
] );
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, $prefix . '_jumbotron_title_color', [
	'label'    => __( 'Title Color', 'illdy' ),
	'section'  => $prefix . '_jumbotron_general',
	'settings' => $prefix . '_jumbotron_title_color',
] ) );

$wp_customize->add_setting( $prefix . '_jumbotron_points_color', [
	'sanitize_callback' => 'sanitize_hex_color',
	'default'           => '#f1d204',
	'transport'         => 'postMessage',
] );
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, $prefix . '_jumbotron_points_color', [
	'label'    => __( 'Title Points Color', 'illdy' ),
	'section'  => $prefix . '_jumbotron_general',
	'settings' => $prefix . '_jumbotron_points_color',
] ) );

$wp_customize->add_setting( $prefix . '_jumbotron_descriptions_color', [
	'sanitize_callback' => 'sanitize_hex_color',
	'default'           => '#fff',
	'transport'         => 'postMessage',
] );
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, $prefix . '_jumbotron_descriptions_color', [
	'label'    => __( 'Description Color', 'illdy' ),
	'section'  => $prefix . '_jumbotron_general',
	'settings' => $prefix . '_jumbotron_descriptions_color',
] ) );

$wp_customize->add_setting( $prefix . '_jumbotron_first_button_color', [
	'sanitize_callback' => 'sanitize_hex_color',
	'default'           => '#fff',
	'transport'         => 'postMessage',
] );
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, $prefix . '_jumbotron_first_button_color', [
	'label'    => __( 'Left Button Text Color', 'illdy' ),
	'section'  => $prefix . '_jumbotron_general',
	'settings' => $prefix . '_jumbotron_first_button_color',
] ) );

$wp_customize->add_setting( $prefix . '_jumbotron_right_button_color', [
	'sanitize_callback' => 'sanitize_hex_color',
	'default'           => '#fff',
	'transport'         => 'postMessage',
] );
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, $prefix . '_jumbotron_right_button_color', [
