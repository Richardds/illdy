...
$wp_customize->add_setting( $prefix . '_archive_page_background_stretch', [
	'sanitize_callback' => 'illdy_sanitize_select',
	'default'           => 1,
] );
$wp_customize->add_control( $prefix . '_archive_page_background_stretch', [
...
$wp_customize->add_section( $prefix . '_blog_featured_section', [
...
$wp_customize->add_setting( $prefix . '_disable_random_featured_image', [
	'sanitize_callback' => $prefix . '_sanitize_checkbox',
	'default'           => 0,
	'transport'         => 'postMessage',
] );

$wp_customize->add_control( new Epsilon_Control_Toggle( $wp_customize, $prefix . '_disable_random_featured_image', [
	'type'        => 'epsilon-toggle',
...
$wp_customize->add_control( new Epsilon_Control_Toggle( $wp_customize, $prefix . '_enable_post_posted_on_blog_posts', [
	'type'        => 'epsilon-toggle',
...
$wp_customize->add_control( new Epsilon_Control_Toggle( $wp_customize, $prefix . '_enable_post_category_blog_posts', [
	'type'        => 'epsilon-toggle',
...
$wp_customize->add_control( new Epsilon_Control_Toggle( $wp_customize, $prefix . '_enable_post_tags_blog_posts', [
	'type'        => 'epsilon-toggle',
...
$wp_customize->add_control( new Epsilon_Control_Toggle( $wp_customize, $prefix . '_enable_post_comments_blog_posts', [
	'type'        => 'epsilon-toggle',
...
$wp_customize->add_control( new Epsilon_Control_Toggle( $wp_customize, $prefix . '_enable_author_box_blog_posts', [
	'type'        => 'epsilon-toggle',
