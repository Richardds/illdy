...
$wp_customize->add_control( new Epsilon_Control_Toggle( $wp_customize, $prefix . '_counter_general_show', [
	'type'     => 'epsilon-toggle',
...
// Type of Background
$wp_customize->add_setting( $prefix . '_counter_background_type', [
	'default'           => 'image',
	'sanitize_callback' => 'illdy_sanitize_radio_buttons',
	'transport'         => 'postMessage',
] );
$wp_customize->add_control( $prefix . '_counter_background_type', [
...
// Image
$wp_customize->add_setting( $prefix . '_counter_background_image', [
	'sanitize_callback' => 'esc_url_raw',
	'default'           => esc_url( get_template_directory_uri() . '/layout/images/front-page/front-page-counter.jpg' ),
	'transport'         => 'postMessage',
] );
$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, $prefix . '_counter_background_image', [
...
// Color
$wp_customize->add_setting( $prefix . '_counter_background_color', [
	'sanitize_callback' => 'sanitize_hex_color',
	'default'           => '#000000',
	'transport'         => 'postMessage',
] );
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, $prefix . '_counter_background_color', [
...
$wp_customize->add_control( new Epsilon_Control_Button( $wp_customize, $prefix . '_counters_widget_button', [
