...
class Illdy{
	...
	function __construct() {
		...
		$this->recommended_actions = apply_filters( 'illdy_required_actions', [
			[
	...
	public function init_color_scheme() {
		...
		$args    = [
			'fields' => [
				...
				'epsilon_secondary_accent_color' => [
	...
	public function init_customizer( $wp_customize ) {
		...
		$wp_customize->add_section( new Epsilon_Section_Recommended_Actions( $wp_customize, 'epsilon_recomended_section', [
