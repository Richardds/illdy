...
<?php if ( '' != $general_title || $jetpack_testimonial_query->have_posts() ) { ?>
    ...
    <section id="testimonials" class="front-page-section" style="<?php if ( $general_background_image ) : echo 'background-image: url(' . esc_url( $general_background_image ) . ')';
		...
		<?php endif; ?>
		<?php if ( post_type_exists( 'jetpack-testimonial' ) ) : ?><?php
			?><?php $count_posts = wp_count_posts( 'jetpack-testimonial' ); ?><?php if ( $jetpack_testimonial_query->have_posts() ) : ?>
                        ...
                        <div class="row">
                            <div class="col-sm-10 col-sm-offset-1 no-padding">
                                <div class="testimonials-carousel <?php if ( $count_posts->publish > 1 ) : echo 'owl-carousel-enabled';
									...
									<?php while ( $jetpack_testimonial_query->have_posts() ) : ?><?php $jetpack_testimonial_query->the_post(); ?>
                                        <div class="carousel-testimonial" style="<?php if ( 1 == $count_posts->publish ) : echo 'margin-bottom: 42px;';
                                            ...
                                            <div class="testimonial-content">
                                                <blockquote><q><?php echo esc_html( get_the_content() ); ?></q>
                                                </blockquote>
			...
			<?php endif; ?><?php wp_reset_postdata(); ?><?php elseif ( current_user_can( 'edit_theme_options' ) ) : ?>
            <div class="section-content">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-10 col-sm-offset-1 no-padding">
