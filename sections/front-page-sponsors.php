...
if ( current_user_can( 'edit_theme_options' ) ) {
	$general_title = get_theme_mod( 'illdy_sponsors_general_title', esc_html__( 'Sponsors', 'illdy' ) );
	$general_entry = get_theme_mod( 'illdy_sponsors_general_entry', esc_html__( 'You\'ll love our work. Check it out!', 'illdy' ) );
} else {
...
<?php if ( '' != $general_title || '' != $general_entry || is_active_sidebar( 'front-page-sponsors-sidebar' ) ) { ?>

    <section id="sponsors" class="front-page-section" style="<?php if ( ! $general_title && ! $general_entry ) : echo 'padding-top: 0;';
	endif; ?>">
